...
<body>
    ...
    <div class="container">
        ...
        <h2 class="text-center text-info mt-4"><small>Invoice Details</small></h2>
    </div>
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th scope="col">Invoice Paid Date</th>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                        <a href="InvoiceInfo.php" class="btn btn-success btn-sm"><small>Insert</small></a>    
